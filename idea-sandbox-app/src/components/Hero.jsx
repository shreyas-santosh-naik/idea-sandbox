      ...
      <div className="container hero-container">
        <div className="animate-scale-in delay-200">
          ...
          <p className="hero-description animate-fade-in-up delay-200">
            The Idea Sandbox is a dynamic and collaborative platform designed to replace the traditional, static suggestion box with a living space for company-wide innovation. It’s where your voice is heard, your suggestions are refined, and your ideas help shape our future.
          </p>
